...
class MasterSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        \Solunes\Master\App\Node::create(['name'=>'product-bridge-variation', 'table_name'=>'product_bridge_variation', 'model'=>'\App\Variation', 'type'=>'field', 'parent_id'=>$node_product_bridge->id]);
